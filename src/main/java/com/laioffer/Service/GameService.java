...
import com.laioffer.entity.db.Item;
import com.laioffer.entity.db.ItemType;
import com.laioffer.entity.response.Game;
...
public class GameService {
    private static final String TOKEN = "Bearer we5tdthtmjeojj32qgq9rajnm4t9gu";
    private static final String CLIENT_ID = "frmmipcyf0rjho2voa247v9gkk0p44";
    ...
    private List<Item> searchVideos(String gameId, int limit) {
        String data = searchTwitch(buildSearchURL(VIDEO_SEARCH_URL_TEMPLATE, gameId, limit));
