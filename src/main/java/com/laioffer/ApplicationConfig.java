...
public class ApplicationConfig {
    ...
    public LocalSessionFactoryBean sessionFactory() {
        ...
        sessionFactory.setPackagesToScan("com.laioffer.entity.db");
    ...
    public DataSource dataSource() {
        String RDS_ENDPOINT = "twitch.czfdamwwxd42.us-east-1.rds.amazonaws.com";
        String USERNAME = "admin";
        String PASSWORD = "Q4qtpdxg999029";
